...
var _ = ginkgo.Describe("MessagingCoreBasicTests", func() {
	...
	var (
		...
		MessageCount  = 100
		Port          = int64(bdw2.AcceptorPorts[bdw2.CoreAcceptor])
	...
	ginkgo.It("Deploy single broker instance and send/receive messages", func() {
		testBaseSendReceiveMessages(bdw, srw, MessageCount, MessageBody, bdw2.CoreAcceptor, 1, ProtocolName)

	})

	ginkgo.It("Deploy single amqp broker instance and send/receive core messages", func() {
		testBaseSendReceiveMessages(bdw, srw, MessageCount, MessageBody, bdw2.AmqpAcceptor, 1, ProtocolName)
	})
	...
	ginkgo.It("Deploy double broker instances, send messages", func() {
		testBaseSendReceiveMessages(bdw, srw, MessageCount, MessageBody, bdw2.CoreAcceptor, 2, ProtocolName)
	})
})
